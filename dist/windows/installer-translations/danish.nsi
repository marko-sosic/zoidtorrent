...
LangString inst_qbt_req ${LANG_DANISH} "zoidtorrent (påkrævet)"
...
LangString inst_startup ${LANG_DANISH} "Start zoidtorrent i Windows opstart"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_DANISH} "Åbn .torrent-filer med zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_DANISH} "Åbn magnet-links med zoidtorrent"
...
LangString inst_warning ${LANG_DANISH} "zoidtorrent kører. Luk venligst programmet inden installation."
...
LangString launch_qbt ${LANG_DANISH} "Start zoidtorrent."
...
LangString inst_requires_win7 ${LANG_DANISH} "This zoidtorrent version requires at least Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_DANISH} "Uninstall zoidtorrent"
...
LangString uninst_warning ${LANG_DANISH} "zoidtorrent kører. Luk venligst programmet inden afinstallation."
