...
LangString inst_qbt_req ${LANG_DUTCH} "zoidtorrent (vereist)"
...
LangString inst_startup ${LANG_DUTCH} "zoidtorrent starten bij opstarten van Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_DUTCH} "Torrentbestanden openen met zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_DUTCH} "Magneetkoppelingen openen met zoidtorrent"
...
LangString inst_warning ${LANG_DUTCH} "zoidtorrent is actief. Sluit het af voordat u deze update installeert."
...
LangString launch_qbt ${LANG_DUTCH} "zoidtorrent starten."
...
LangString inst_requires_win7 ${LANG_DUTCH} "Deze versie van zoidtorrent vereist ten minste Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_DUTCH} "Uninstall zoidtorrent"
...
LangString uninst_warning ${LANG_DUTCH} "zoidtorrent is actief. Sluit het af voordat u het verwijdert."
