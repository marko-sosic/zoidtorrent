...
LangString inst_qbt_req ${LANG_FINNISH} "zoidtorrent (pakollinen)"
...
LangString inst_startup ${LANG_FINNISH} "Käynnistä zoidtorrent Windowsin käynnistyessä"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_FINNISH} "Avaa .torrent tiedostot zoidtorrentilla"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_FINNISH} "Avaa magnet-linkit zoidtorrentilla"
...
LangString inst_warning ${LANG_FINNISH} "zoidtorrent on käynnissä. Sulje ohjelma ennen asennusta."
...
LangString launch_qbt ${LANG_FINNISH} "Käynnistä zoidtorrent."
...
LangString inst_requires_win7 ${LANG_FINNISH} "Tämä zoidtorrent versio tarvitsee vähintään Windows 7:n."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_FINNISH} "Uninstall zoidtorrent"
...
LangString uninst_warning ${LANG_FINNISH} "zoidtorrent on käynnissä. Sulje ohjelma ennen poistamista."
