...
LangString inst_qbt_req ${LANG_FRENCH} "zoidtorrent (requis)"
...
LangString inst_startup ${LANG_FRENCH} "Démarrez zoidtorrent au démarrage de Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_FRENCH} "Ouvrir fichiers .torrent avec zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_FRENCH} "Ouvrir liens magnet avec zoidtorrent"
...
LangString inst_warning ${LANG_FRENCH} "zoidtorrent est en cours d'exécution. Veuillez fermer l'application avant l'installation."
...
LangString launch_qbt ${LANG_FRENCH} "Lancer zoidtorrent."
...
LangString inst_requires_win7 ${LANG_FRENCH} "Cette version de zoidtorrent nécessite au moins Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_FRENCH} "Uninstall zoidtorrent"
...
LangString uninst_warning ${LANG_FRENCH} "zoidtorrent est en cours d'exécution. Veuillez fermer l'application avant la désinstallation."
