...
LangString inst_qbt_req ${LANG_GERMAN} "zoidtorrent (erforderlich)"
...
LangString inst_startup ${LANG_GERMAN} "zoidtorrent mit Windows starten"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_GERMAN} "Öffne .torrent-Dateien mit zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_GERMAN} "Öffne Magnet-Links mit zoidtorrent"
...
LangString inst_warning ${LANG_GERMAN} "zoidtorrent läuft gerade. Bitte das Programm vor der Installation beenden."
...
LangString launch_qbt ${LANG_GERMAN} "Starte zoidtorrent."
...
LangString inst_requires_win7 ${LANG_GERMAN} "Diese Version von zoidtorrent erfordert mindestens Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_GERMAN} "zoidtorrent deinstallieren"
...
LangString uninst_warning ${LANG_GERMAN} "zoidtorrent läuft gerade. Bitte das Programm vor der Deinstallation beenden."
