...
LangString inst_qbt_req ${LANG_GREEK} "zoidtorrent (απαιτείται)"
...
LangString inst_startup ${LANG_GREEK} "Ξεκινήστε το zoidtorrent στα Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_GREEK} "Άνοιγμα των αρχείων .torrent με το zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_GREEK} "Άνοιγμα των μαγνητικών συνδέσμων με το zoidtorrent"
...
LangString inst_warning ${LANG_GREEK} "Το zoidtorrent βρίσκεται σε εκτέλεση. Παρακαλούμε κλείστε την εφαρμογή πριν την εγκατάσταση."
...
LangString launch_qbt ${LANG_GREEK} "Εκκίνηση του zoidtorrent."
...
LangString inst_requires_win7 ${LANG_GREEK} "This zoidtorrent version requires at least Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_GREEK} "Uninstall zoidtorrent"
...
LangString uninst_warning ${LANG_GREEK} "Το zoidtorrent βρίσκεται σε εκτέλεση. Παρακαλούμε κλείστε την εφαρμογή πριν την απεγκατάσταση."
