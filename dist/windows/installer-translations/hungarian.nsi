...
LangString inst_qbt_req ${LANG_HUNGARIAN} "zoidtorrent (kötelező)"
...
LangString inst_startup ${LANG_HUNGARIAN} "zoidtorrent indítása Windows indításakor"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_HUNGARIAN} ".torrent fájlok megnyitása zoidtorrenttel"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_HUNGARIAN} "Magnet linkek megnyitása zoidtorrenttel"
...
LangString inst_warning ${LANG_HUNGARIAN} "A zoidtorrent fut. Kérem zárjba be az alkalmazást a telepítés előtt."
...
LangString launch_qbt ${LANG_HUNGARIAN} "zoidtorrent indítása."
...
LangString inst_requires_win7 ${LANG_HUNGARIAN} "A zoidtorrent ezen verziójához minimum Windows 7 szükséges."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_HUNGARIAN} "zoidtorrent eltávolítása"
...
LangString uninst_warning ${LANG_HUNGARIAN} "A zoidtorrent jelenleg is fut. Kérem zárja be az alkalmazást mielőtt eltávolítaná."
