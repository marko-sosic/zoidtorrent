...
LangString inst_qbt_req ${LANG_ITALIAN} "zoidtorrent (necessario)"
...
LangString inst_startup ${LANG_ITALIAN} "Esegui zoidtorrent all'avvio di Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_ITALIAN} "Apri file .torrent con zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_ITALIAN} "Apri collegamenti magnet con zoidtorrent"
...
LangString inst_warning ${LANG_ITALIAN} "zoidtorrent è in esecuzione. Chiudilo prima di procedere con l'installazione."
...
LangString launch_qbt ${LANG_ITALIAN} "Esegui zoidtorrent."
...
LangString inst_requires_win7 ${LANG_ITALIAN} "Questa versione di zoidtorrent richiede Windows 7 o versioni successive."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_ITALIAN} "Disinstalla zoidtorrent"
...
LangString uninst_warning ${LANG_ITALIAN} "zoidtorrent è in esecuzione. Chiudilo prima di procedere con la disinstallazione."
