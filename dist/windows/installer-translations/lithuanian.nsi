...
LangString inst_qbt_req ${LANG_LITHUANIAN} "zoidtorrent (reikalingas)"
...
LangString inst_startup ${LANG_LITHUANIAN} "Pradėti „zoidtorrent“ paleidus „Windows“"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_LITHUANIAN} "Atidaryti .torrent failus su zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_LITHUANIAN} "Atidaryti magneto nuorodas su zoidtorrent"
...
LangString inst_warning ${LANG_LITHUANIAN} "zoidtorrent yra paleistas. Prašau uždaryti programą prieš įdiegiant."
...
LangString launch_qbt ${LANG_LITHUANIAN} "Paleisti zoidtorrent."
...
LangString inst_requires_win7 ${LANG_LITHUANIAN} "This zoidtorrent version requires at least Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_LITHUANIAN} "Uninstall zoidtorrent"
...
LangString uninst_warning ${LANG_LITHUANIAN} "zoidtorrent yra paleistas. Prašau uždarykite programą prieš išdiegiant."
