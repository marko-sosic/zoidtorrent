...
LangString inst_qbt_req ${LANG_LUXEMBOURGISH} "zoidtorrent (required)"
...
LangString inst_startup ${LANG_LUXEMBOURGISH} "Start zoidtorrent on Windows start up"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_LUXEMBOURGISH} "Open .torrent files with zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_LUXEMBOURGISH} "Open magnet links with zoidtorrent"
...
LangString inst_warning ${LANG_LUXEMBOURGISH} "zoidtorrent is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_LUXEMBOURGISH} "Launch zoidtorrent."
...
LangString inst_requires_win7 ${LANG_LUXEMBOURGISH} "This zoidtorrent version requires at least Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_LUXEMBOURGISH} "Uninstall zoidtorrent"
...
LangString uninst_warning ${LANG_LUXEMBOURGISH} "zoidtorrent is running. Please close the application before uninstalling."
