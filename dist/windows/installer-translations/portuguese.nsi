...
LangString inst_qbt_req ${LANG_PORTUGUESE} "zoidtorrent (obrigatório)"
...
LangString inst_startup ${LANG_PORTUGUESE} "Iniciar o zoidtorrent na inicialização do Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_PORTUGUESE} "Abrir ficheiros .torrent com o zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_PORTUGUESE} "Abrir ligações magnet com o zoidtorrent"
...
LangString inst_warning ${LANG_PORTUGUESE} "O zoidtorrent está a ser executado. Feche a aplicação antes de instalar esta versão."
...
LangString launch_qbt ${LANG_PORTUGUESE} "Iniciar zoidtorrent."
...
LangString inst_requires_win7 ${LANG_PORTUGUESE} "This zoidtorrent version requires at least Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_PORTUGUESE} "Uninstall zoidtorrent"
...
LangString uninst_warning ${LANG_PORTUGUESE} "O zoidtorrent está a ser executado. Feche a aplicação antes de desinstalar esta versão."
