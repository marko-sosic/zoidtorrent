...
LangString inst_qbt_req ${LANG_PORTUGUESEBR} "zoidtorrent (requerido)"
...
LangString inst_startup ${LANG_PORTUGUESEBR} "Iniciar o zoidtorrent na inicialização do Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_PORTUGUESEBR} "Abrir arquivos .torrent com o zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_PORTUGUESEBR} "Abrir links magnet com o zoidtorrent"
...
LangString inst_warning ${LANG_PORTUGUESEBR} "O zoidtorrent está em execução. Por favor feche o aplicativo antes de instalar."
...
LangString launch_qbt ${LANG_PORTUGUESEBR} "Executar o zoidtorrent."
...
LangString inst_requires_win7 ${LANG_PORTUGUESEBR} "Esta versão do zoidtorrent requer no mínimo o Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_PORTUGUESEBR} "Desinstalar o zoidtorrent"
...
LangString uninst_warning ${LANG_PORTUGUESEBR} "O zoidtorrent está em execução. Por favor feche o aplicativo antes de desinstalar."
