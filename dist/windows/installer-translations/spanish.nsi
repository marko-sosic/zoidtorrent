...
LangString inst_qbt_req ${LANG_SPANISH} "zoidtorrent (necesario)"
...
LangString inst_startup ${LANG_SPANISH} "Inicie zoidtorrent en el inicio de Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_SPANISH} "Abrir archivos .torrent con zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_SPANISH} "Abrir enlaces magnet con zoidtorrent"
...
LangString inst_warning ${LANG_SPANISH} "zoidtorrent se está ejecutando. Ciérrelo antes de continuar."
...
LangString launch_qbt ${LANG_SPANISH} "Iniciar zoidtorrent."
...
LangString inst_requires_win7 ${LANG_SPANISH} "This zoidtorrent version requires at least Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_SPANISH} "Uninstall zoidtorrent"
...
LangString uninst_warning ${LANG_SPANISH} "zoidtorrent se está ejecutando. Ciérrelo antes de continuar."
