...
LangString inst_qbt_req ${LANG_SPANISHINTERNATIONAL} "zoidtorrent (necesario)"
...
LangString inst_startup ${LANG_SPANISHINTERNATIONAL} "Inicie zoidtorrent en el inicio de Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_SPANISHINTERNATIONAL} "Abrir archivos .torrent con zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_SPANISHINTERNATIONAL} "Abrir enlaces magnet con zoidtorrent"
...
LangString inst_warning ${LANG_SPANISHINTERNATIONAL} "zoidtorrent se está ejecutando. Ciérrelo antes de continuar."
...
LangString launch_qbt ${LANG_SPANISHINTERNATIONAL} "Iniciar zoidtorrent."
...
LangString inst_requires_win7 ${LANG_SPANISHINTERNATIONAL} "This zoidtorrent version requires at least Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_SPANISHINTERNATIONAL} "Uninstall zoidtorrent"
...
LangString uninst_warning ${LANG_SPANISHINTERNATIONAL} "zoidtorrent se está ejecutando. Ciérrelo antes de continuar."
