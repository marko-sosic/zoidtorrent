...
LangString inst_qbt_req ${LANG_SWEDISH} "zoidtorrent (krävs)"
...
LangString inst_startup ${LANG_SWEDISH} "Starta zoidtorrent vid Windows start"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_SWEDISH} "Öppna .torrent-filer med zoidtorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_SWEDISH} "Öppna magnetlänkar med zoidtorrent"
...
LangString inst_warning ${LANG_SWEDISH} "zoidtorrent körs. Vänligen stäng programmet innan du installerar."
...
LangString launch_qbt ${LANG_SWEDISH} "Kör zoidtorrent."
...
LangString inst_requires_win7 ${LANG_SWEDISH} "Den här zoidtorrent-versionen kräver minst Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_SWEDISH} "Avinstallera zoidtorrent"
...
LangString uninst_warning ${LANG_SWEDISH} "zoidtorrent körs. Vänligen stäng programmet innan du avinstallerar."
