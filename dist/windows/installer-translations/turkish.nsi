...
LangString inst_qbt_req ${LANG_TURKISH} "zoidtorrent (zorunlu)"
...
LangString inst_startup ${LANG_TURKISH} "Windows başlangıcında zoidtorrent'i başlat"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with zoidtorrent"
LangString inst_torrent ${LANG_TURKISH} ".torrent dosyalarını zoidtorrent ile aç"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with zoidtorrent"
LangString inst_magnet ${LANG_TURKISH} "Magnet bağlantılarını zoidtorrent ile aç"
...
LangString inst_warning ${LANG_TURKISH} "zoidtorrent çalışıyor. Lütfen yüklemeden önce uygulamayı kapatın."
...
LangString launch_qbt ${LANG_TURKISH} "zoidtorrent'i başlat"
...
LangString inst_requires_win7 ${LANG_TURKISH} "Bu zoidtorrent sürümü en az Windows 7 gerektirir."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall zoidtorrent"
LangString inst_uninstall_link_description ${LANG_TURKISH} "zoidtorrent'i kaldır"
...
LangString uninst_warning ${LANG_TURKISH} "zoidtorrent çalışıyor. Lütfen kaldırmadan önce uygulamayı kapatın."
