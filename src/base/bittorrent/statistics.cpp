...
void Statistics::save() const
{
    ...
    SettingsPtr s = Profile::instance()->applicationSettings(QLatin1String("zoidtorrent-data"));
    QVariantHash v;
...
{
    const SettingsPtr s = Profile::instance()->applicationSettings(QLatin1String("zoidtorrent-data"));
